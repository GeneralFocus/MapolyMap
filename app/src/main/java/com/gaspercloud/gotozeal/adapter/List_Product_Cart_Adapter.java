...
public class List_Product_Cart_Adapter extends RecyclerView.Adapter<List_Product_Cart_Adapter.MyViewHolder> {
    ...
    public List_Product_Cart_Adapter(Context mContext, List<CartModelOLD> cartProductList, FragmentActivity fragment, boolean is_Cart_Wishlist) {
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                            ...
                                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                if (task.isSuccessful() && task.getResult() != null) {
                                                    //all_cost = 0;
                                                    homeViewModel.getMutableLiveCartModel().setValue(task.getResult().toObjects(CartModel.class));
